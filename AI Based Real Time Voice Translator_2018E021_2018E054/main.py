...
win.title("AI Based Voice Translator_2018E021_2018E054")
...
def open_about_page():      # about page
    ...
    An AI based learning project that translates voice from one language to another in real time while preserving the tone and emotion of the speaker, and outputs the result in MP3 format. Choose input and output languages from the dropdown menu and start the translation!
    """)
    about_text.pack()
